<%@ Page Title="" Language="C#" MasterPageFile="~/Dynamic.Master" AutoEventWireup="true" CodeBehind="AlbamWiseImage.aspx.cs" Inherits="DynamicMenu.WebSitePanel.UI.AlbamWiseImage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function GetCompletionListRoomNM() {
            $("#<%=txtAlbamNM.ClientID %>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: "../../search.asmx/GetCompletionListAlbamNM",
                        type: "POST",
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        data: "{ 'txt' : '" + $("#<%=txtAlbamNM.ClientID %>").val() + "'}",
                ...
                select: function (event, ui) {
                    $("#<%=txtAlbamId.ClientID %>").val(ui.item.x);
            ...
            function deleteslide(imgid) {
                if (confirm("Are you Sure to Delete?")) {
                    $.ajax({
                        url: "AlbamWiseImage.aspx/DeleteSlide",
                        contentType: "application/json; charset=utf-8;",
                        type: "POST",
                        dataType: "json",
                        data: "{ 'id' : '" + imgid + "'}",
        ...
        <div id="contentBox">
            ...
            <div class="form-class">
                ...
                <div class="row form-class">
                    <div class="col-md-1">Albam</div>
                    <div class="col-md-3">
                        <asp:TextBox ID="txtAlbamNM" class="form-control input-sm" placeholder="Albam Name" runat="server" AutoPostBack="True" OnTextChanged="txtAlbamNM_OnTextChanged"></asp:TextBox>
                        <asp:TextBox runat="server" ID="txtAlbamId" style="display: none"></asp:TextBox>
                    </div>
