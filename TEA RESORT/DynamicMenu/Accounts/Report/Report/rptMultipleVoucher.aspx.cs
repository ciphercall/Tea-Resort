...
namespace AlchemyAccounting.Accounts.Report.Report
{
    public partial class rptMultipleVoucher : System.Web.UI.Page
    {
        ...
        public void ShowGrid_MREC()
        {
            ...
            if (TransType == "MREC")
            {
                SqlCommand cmd = new SqlCommand(" SELECT GL_MTRANS.SERIALNO, GL_ACCHART.ACCOUNTNM, GL_ACCHART_1.ACCOUNTNM AS CREDIT, GL_MTRANS.TRANSMODE+' - ' + GL_MTRANS.REMARKS  AS REMARKS, GL_MTRANS.AMOUNT FROM GL_MTRANS INNER JOIN " +
