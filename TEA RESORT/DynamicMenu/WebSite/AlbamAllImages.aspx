<%@ Page Title="" Language="C#" MasterPageFile="~/WebSite/WebSiteMasterPage.Master" AutoEventWireup="true" CodeBehind="AlbamAllImages.aspx.cs" Inherits="DynamicMenu.WebSite.AlbamAllImages" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section id="overview">
        <div class="container">
            <div class="row">
                <div class="row">
                    <asp:Repeater runat="server" ID="rpttr1">
                        <ItemTemplate>
                            <div class="col-md-3">
                                <article class="room" style="margin-bottom: 20px">
                                    <figure>
                                       ...
                                       <%-- <figcaption>
                                            ...
                                            <%-- <h5><asp:LinkButton ID="hypAlbam" runat="server"  Text='<%#Eval("ALBAMNM")%>' CommandName="BidNow" CommandArgument='<%#Eval("ROOMID")+","+Eval("IMGURL")+","+Eval("ROOMRT")+","+Eval("ROOMNM")%>'></asp:LinkButton></h5>--%>
                                            <%--  <span class="f_right">
